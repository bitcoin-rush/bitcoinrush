...
#ifndef BITCOINRUSH_INTERFACES_NODE_H
#define BITCOINRUSH_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinrush node (bitcoinrushd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINRUSH_INTERFACES_NODE_H
