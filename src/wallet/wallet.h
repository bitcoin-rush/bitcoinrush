...
#ifndef BITCOINRUSH_WALLET_WALLET_H
#define BITCOINRUSH_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinrush node, and set to 0 for transactions that were created
...
#endif // BITCOINRUSH_WALLET_WALLET_H
