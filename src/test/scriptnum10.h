...
#ifndef BITCOINRUSH_TEST_SCRIPTNUM10_H
#define BITCOINRUSH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoinrush Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRUSH_TEST_BIGNUM_H
