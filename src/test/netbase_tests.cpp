...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinrushcore.org", "www.bitcoinrushcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinrushcore.org]", "www.bitcoinrushcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinrushcore.org:80", "www.bitcoinrushcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinrushcore.org]:80", "www.bitcoinrushcore.org", 80));
