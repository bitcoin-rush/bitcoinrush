...
static void SetupBitcoinrushTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinrush-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinrush-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinrush transaction\n" +
            "or:     bitcoinrush-tx [options] -create [commands]   Create hex-encoded bitcoinrush transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinrush transaction
