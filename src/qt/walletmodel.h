...
#ifndef BITCOINRUSH_QT_WALLETMODEL_H
#define BITCOINRUSH_QT_WALLETMODEL_H
...
/** Interface to Bitcoinrush wallet from Qt view code. */
...
#endif // BITCOINRUSH_QT_WALLETMODEL_H
