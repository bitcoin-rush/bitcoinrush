...
#ifndef BITCOINRUSH_QT_BITCOINRUSHUNITS_H
#define BITCOINRUSH_QT_BITCOINRUSHUNITS_H
...
/** Bitcoinrush unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinrushUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinrushUnits(QObject *parent);

    /** Bitcoinrush units.
      @note Source: https://en.bitcoinrush.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RUSH,
...
typedef BitcoinrushUnits::Unit BitcoinrushUnit;

#endif // BITCOINRUSH_QT_BITCOINRUSHUNITS_H
