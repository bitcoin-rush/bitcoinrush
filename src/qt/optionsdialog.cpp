    ...
    mapper(0)
{
    ...
    ui->bitcoinrushAtStartup->setToolTip(ui->bitcoinrushAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinrushAtStartup->setText(ui->bitcoinrushAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinrushConfButton->setToolTip(ui->openBitcoinrushConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinrushUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinrushAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinrushConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinrushConf())
