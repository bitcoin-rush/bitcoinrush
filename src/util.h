 ...
 */
#ifndef BITCOINRUSH_UTIL_H
#define BITCOINRUSH_UTIL_H
...
extern const char * const BITCOINRUSH_CONF_FILENAME;
extern const char * const BITCOINRUSH_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinrush-%s", name);
