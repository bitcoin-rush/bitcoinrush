...
"""Verify that starting bitcoinrush with -h works as expected."""

from test_framework.test_framework import BitcoinrushTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinrushTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinrush with -h for help text")
        ...
        self.log.info("Start bitcoinrush with -version for version information")
        ...
        self.log.info("Start bitcoinrushd with -fakearg to make sure it does not start")
