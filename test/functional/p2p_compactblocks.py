...
# TestP2PConn: A peer we use to send messages to bitcoinrushd, and store responses.
...
class CompactBlocksTest(BitcoinrushTestFramework):
    ...
    # This test actually causes bitcoinrushd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinrushd's choice of nonce.
    ...
    # Test that bitcoinrushd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinrushd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinrushd will not send blocktxn responses for blocks whose height is
